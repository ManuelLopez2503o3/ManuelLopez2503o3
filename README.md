...
<p align="center">
 ...
 Bienvenidos 
 soy Manuel Alejandro

💻 Desarrollador de Software enfocado en Backend  
🎓 TSU en Desarrollo de Software | Ingeniería en curso  
🚀 Apasionado por crear soluciones eficientes y optimizar procesos  

---

## 🧠 Sobre mí
Soy estudiante de Ingeniería en Desarrollo de Software con experiencia en desarrollo backend, bases de datos y desarrollo web.  
...
- Optimización de tiempos en alta demanda
- Lógica de negocio para evitar saturación del sistema
- Manejo de datos con PostgreSQL

### 🐶 App de Impacto Social (Fullstack)
- Plataforma para reportes ciudadanos (React + Laravel)
- Conexión entre donantes y refugios
- Mejora en tiempos de respuesta para rescates
